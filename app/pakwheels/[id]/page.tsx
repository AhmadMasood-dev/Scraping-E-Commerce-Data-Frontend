...
import { ArrowLeft, MapPin, Fuel, Gauge, Calendar, Settings2, ArrowUpRight, Inbox } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            ...
            {v.city      && <Spec icon={MapPin}     label="City"         value={v.city} />}
          </div>
          ...
          {v.description && (
            <Card className="p-5 rounded-2xl border shadow-soft">
              <p className="text-foreground leading-relaxed text-sm">{v.description}</p>
            </Card>
          )}
